# Thumbnail Strategy Menu

Six thumbnail strategies. Pick one or two to test. Find the one the specific audience responds to, then repeat it consistently.
...
Side-by-side visual transformation. Shows proof in the thumbnail itself.

Examples:
- Man at 275 lbs → 175 lbs with an arrow between numbers
- Beginner splits → advanced splits ("FROM HERE" → "TO HERE")
- Wrinkled skin ("NO GEL") vs. smooth skin ("WITH GEL")

**Rule:** if the visual transformation isn't obvious at a glance, this strategy doesn't work. Best for fitness, DIY, creative, and results-focused niches.

### 3. Result

Show or tease the exact outcome viewers want. No transformation needed. Just the end state.

Examples:
- "$712,921.88" as pure result
- "481% FASTER" on a clean graphic
- A perfectly made-up eye as the desired result
- A well-lit studio setup as the aspirational result
- A muscular back labeled "BACK / BICEPS"

Works when a desirable result can be displayed visually.

### 4. Social Hacking

Feature a well-known person or brand in the thumbnail. Borrows their recognition.

Examples:
- Famous creators with tape over their mouths
- Celebrity faces (like a famous musician)
...
Force the viewer to ask how, what, or why before they read the title.

Examples:
- "this is a lie" with a circled "M" key on an iPhone keyboard
- "DELETE THIS" on a video timeline
- "QUIT EVERYTHING" with a result promise
- A stop sign pointed at a guitar

**Rule:** pair with an intro that immediately delivers on the implied promise. Strong for cold audiences but carries the highest clickbait risk.

### 6. Minimal

High-quality, text-free or near-text-free photograph. Lets image quality do the work.

Examples:
- Cinematic shot of a camera lens on autumn leaves
...
Don't pick one strategy permanently upfront. Run a test cycle: post a few thumbnails using different strategies, measure what gets clicks, repeat the winning style as consistently as possible.

The long-term goal: find the one style that works for this specific audience, then repeat it almost identically across every video. Consistency in thumbnail style is a growth signal, not a creative limitation.

## Default starting picks
...
Test 2 strategies. Commit to the winner. Repeat it.

## Mistakes to avoid

- Changing the winning style because the creator gets bored (viewers don't get bored)
- Using Curiosity thumbnails with intros that don't deliver
- Social Hacking every video (wrong audience accumulation)
- Minimal thumbnails on business channels that don't have photo-quality firepower
