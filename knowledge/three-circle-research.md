...
- **Researching channels too large for fair comparison.** Hormozi-tier creators have outliers driven by name recognition. The pattern data is unfair to extract for a smaller channel because the same thumbnail won't perform without the same brand equity.
