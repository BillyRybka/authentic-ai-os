...
**The principle:** if the bank entry's outcome is thin, EITHER route to `vid-capture` to dig deeper before pulling, OR pick a different candidate. Do NOT make up specifics. Anti-fabrication is the gate.
