...
Other people's words about the creator, their work, or their results. Distinct from proof: proof is the creator's own evidence (numbers, screenshots, credentials), testimonials are what clients/viewers/partners said in their own voice.

## What goes here

One file per testimonial. Sources:

- **Comment** — YouTube, Instagram, LinkedIn public comment
...
2. `vid-hook` may pull a testimonial for credibility
