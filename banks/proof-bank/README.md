...
- **Client testimonials.** Quotes from other people → `testimonial-bank/` (proof is what YOU can cite about your own work; testimonial is what someone else said)
- **Metaphors or analogies** → `metaphor-bank/`
- **Generic claims.** "I'm good at this" isn't proof. Specific number + scope + timeframe = proof.
...
3. **Presentation format** — static screenshot / before-after / live video clip / inline stat (one or more)
...
2. `vid-hook` pulls proof for the Problem/Proof/Promise intro
