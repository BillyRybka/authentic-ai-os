...
- **vid-capture:** seed is the raw story / metaphor / proof / testimonial / framework; snapshot iceberg.md, avatar.md, and any dedup-candidate entries; bad output is the saved bank entry in full plus the session-close report.
