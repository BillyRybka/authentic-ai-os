...
- **Missing or no Offer/Avatar/Top 3.** Stop. Tell the creator: "Run `vid-avatar` first. I need your offer, avatar, and Top 3 problems before I can draft a sharp Iceberg Statement."
...
- **WHO.** The avatar, in their words. Pulled from the Avatar section of `creator-foundation.md`.
...
Write the locked Iceberg Statement to `foundation/creator-foundation.md` in the Iceberg Statement section.
...
- Asking for the offer, avatar, or Top 3 problems. Those were locked by `vid-avatar` and live in `creator-foundation.md`.
