...
tags: [foundation, packaging, format-rotation, thumbnail, title]
---
...
### Typography
- Font: [e.g. Poppins, Montserrat, brand-specific]

### Hero element
- [Face / object / text]

### Expression rules
*Allowed expressions for face thumbnails.*

- [e.g. confidence, surprise, focused]
- Avoid: [e.g. overly theatrical, neutral]

### Text limits
- Maximum words in thumbnail: 4-5
- Title character limit: under 50

---

## Creation Path

*Pick one. The workflow for actually making thumbnails.*

- [ ] Photoshop / DIY
- [ ] AI workflow (Google Gemini or similar)
- [ ] Batch-shoot photos
- [ ] Outsource to designer

Notes on the chosen path: [how it works, who's involved, turnaround]

---

## Packaging One-Pager Checklist

*Apply to every video before posting.*
