...
- Lesson-06 line 40: "Missing one emotion brick doesn't kill a video. Obsessing about it causes paralysis. The framework is a guide, not a law." Plus "Nobody dies if you tweak this a little."
...
- Source teaching:
  ...
  - Three phrases: "let's dive in" (B-1), "let's talk about" (B-2), "let me tell you" (B-3). Source frames as "I would also recommend never," a recommendation, not law. Productized auto-rejects without creator visibility.
  - Lesson-11 line 40 backs B-6: "never end a video. Don't say 'and finally.'" That is an explicit ban. Faithful.
  ...
  - ytgs-video-planner line 1870-1874 says "Don't get cute with transitions, they shouldn't take more than 30 seconds to write" plus "the smart move is just to have 3-4 you use over and over again." Source treats transitions as flexible default-set, not a 13-phrase blocklist.
...
- Source teaching:
  - Lesson-11 line 40: "The golden rule: never end a video. Don't say 'and finally.' Don't recap. Just set up the next problem and point to the video that solves it." That is an explicit ban on "and finally" (B-1 in vid-ending) and on recap (S-1 structural).
  - Lesson-11 line 25 (Ed's own example): "No begging. No 'like and subscribe.' Just a well-positioned next step." That is an explicit ban on "if you liked this, please subscribe" (B-3 in vid-ending).
