...
- **WRITES**: `piece.md` (`selected_angle`, `core_payoff`, `format`, `goal`, `voice_context`) + the `## The Read` body section (Target, Transformation, Stakes, Core payoff) and the dropped-angles body section
