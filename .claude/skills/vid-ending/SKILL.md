...
2. `foundation/voice-profile.md` and `foundation/reference-pieces/*.md` (voice rules and live rhythm)
...
- Layer 1: recurring phrases present, anti-patterns absent, words_avoided absent, POV consistent, energy match
- Layer 2: rhythm matches the YouTube-script context map, opener and closing patterns match
...
| `knowledge/voice-rhythm.md` | Sentence rhythm, paragraph ratio, opener/closing patterns |
| `knowledge/voice-pressure-test.md` | End-of-skill voice validation procedure |
...
| `foundation/voice-profile.md` + `reference-pieces/` | Voice rules and live rhythm exemplars |
