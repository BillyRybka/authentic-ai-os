---
name: vid-framing
description: Find what is at stake for the one viewer and lock what the video argues. Get into the viewer's head, confirm the read with the creator, then find the belief, cost, or blind spot the video pushes against, digging for it when the material arrives flat. Writes the argument, core payoff, format, and goal to piece.md, then hands to vid-title. Use whenever the creator needs the angle picked, even if they don't say "frame". Triggers include "frame the video", "pick the angle", "what should this video be about", "re-frame this piece".
---
...
2. **Read the viewer, then confirm.** From the avatar and the material, go deep on the one person this is for: what they want, what they are actually stuck on, what they believe about it, what changes for them by the end. Name the core payoff, the one thing they walk away able to do. Lay it back in a few plain lines and wait for a yes or a sharpen. Build nothing until they say "that's the video."
...
3. **Find the stake, and dig if it isn't there.** Open `references/stake-finder.md`. Find the belief that is costing them, the cost they cannot see, the thing they feel and cannot name, or the scoreboard they are wrong about. One is enough.

   Most brain-dumps arrive as accurate information with no conflict in them. That is normal. The stake is usually in the creator's head and never made it to the page, so dig for it: one question at a time, in flow, never as a battery. If two rounds surface nothing, say so plainly and give them the three honest options in `stake-finder.md` rather than manufacturing tension. Framing does not kill videos; it names the ceiling out loud.
...
- `## The Read`, four short lines (viewer, what they believe, what it costs them, the payoff). This is the ore vid-title, vid-intro, and vid-structure pull from; without it the read dies in the conversation.
