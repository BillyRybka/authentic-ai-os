#!/usr/bin/env python3
"""Fetch users channel videos sorted by performance metrics.
...
CHANNEL_URL = "https://www.youtube.com/@billy-rybka"
...
def main():
    ...
    print(f"Fetching Billy Rybka channel videos (last {months} months, top {count})...\n", file=sys.stderr)
    ...
    print(f"Billy Rybka ({subs_str} subscribers) \u2014 Top {len(videos)} videos, last {months} months\n")
