...
AI: [light-vets the creator's version: no banned phrases, no em-dash, no words_avoided]
...
AI: Hard issue 2 of 3
    ...
    Issue: "might want to" is a hedge stack flagged in your voice-profile anti_patterns. Undermines stakes.
...
AI: One quick check on your version:
    - "probably" is on your voice-profile anti_patterns (same hedge family as "might"). Same problem as the original.
