...
If the full answer lands in segment 1 or 2 of a 5-segment piece, that is early-payoff. Viewers who got the answer leave.
...
- Title-promise fully resolved in segment 1 or 2 of N (early-payoff)
...
piece.md: `goal: sales`, `viewer_stage: warm`.
...
Issue: Goal is sales, viewer is warm. CTA should reference the offer, not request a subscribe. Warm viewers are ready for the ask.
