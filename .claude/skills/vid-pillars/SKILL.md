...
**Inputs (required):** `foundation/creator-foundation.md` with the Iceberg Statement section locked. Also needs the Avatar and Top 3 problems sections to validate that pillars solve the right problems.

**Inputs (optional):** `foundation/voice-profile.md`.

**Outputs:** Content pillars (bottom of the iceberg) section written to `foundation/creator-foundation.md`. 8 to 12 pillars, numbered.
