...
4. **Identity residue (design guardrails, creation path).** Leave these sections as unfilled stubs marked `# TBD, not yet homed`. Don't interview for them here, and don't fabricate values.
