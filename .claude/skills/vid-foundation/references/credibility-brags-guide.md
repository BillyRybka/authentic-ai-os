# Credibility Brags Guide

Three sentences the creator uses in nearly every intro to signal "this person knows what they're talking about" on THIS specific topic. Not resume brags. Not a list of clients. Three viewer-relevant wins.

## What makes a credibility brag "viewer-relevant"

It answers: "Why should I trust THIS person on THIS topic?" It doesn't answer: "Why should I respect this person?"

**Viewer-relevant brag:**
> "I made $4M from my YouTube channel in 2025."

If the viewer wants YouTube revenue, this lands. The number is specific, the outcome is what the viewer wants.

**Not viewer-relevant:**
> "I've been a digital marketer for 12 years."

The viewer doesn't care about years. They care about whether they'll get the result they want.
...
Why it fails:
- The creator IS the source of failure in this framing
...
Why it works:
- Declarative, past tense, specific scale
- No wiggle words
...
Each brag: one sentence. Specific numbers. Past tense (or present tense for ongoing state). No hedging.
...
In the hook/intro section. Usually after the Problem statement and before the Promise.
...
- Social proof without specifics ("I've worked with some of the top brands")
- Brags that are impressive but irrelevant ("I was featured in Forbes")

## Anti-proof warning

Never write credibility that makes YOU the source of failure.

**Bad proof:**
> "Since 2022, I've built the systems behind dozens of businesses. And the number one reason those systems fail..."

This reads as if the creator builds systems that fail.

**Good proof:**
> "Since 2022, I've built the systems behind dozens of businesses. And the number one mistake I see business owners make before they even talk to me..."

The creator is the expert. The problem is OTHER people's mistake. The creator knows better.

Check every brag for anti-proof framing before locking it.
