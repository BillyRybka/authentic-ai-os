...
**Block candidates:**
- Story: [[story-slug-1]] | [[story-slug-2]] | (no match; vid-segment may use a different block)
...
**Blocks:** [[story-slug]] (the stakes-laden open)
...
**Blocks:** [[proof-slug]] if available
...
**Blocks:** [[framework-slug]], [[proof-slug-week-N-traction]]
...
**Blocks:** [[proof-slug-final-result]], client clip if available
...
**Blocks:** [[framework-slug]] (named as the takeaway)
...
**Blocks:** primary sources, screenshots
...
**Blocks:** [[proof-slug]], [[story-slug-impact]]
...
**Blocks:** [[framework-slug]] if applicable
...
- **Block candidates as wikilinks.** Always `[[slug]]` format. If no bank match, write "(no match; vid-segment may use a different block)" or note inline-craft route.
...
- **Locked block choices in vid-structure.** Surfacing is the job. Locking happens at vid-segment time. Use `|` to list candidates, never single-choice.
