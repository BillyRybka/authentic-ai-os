...
2. `Content/pieces/{slug}/piece.md`, locked framing (`selected_angle`, `core_payoff`, `format`, `goal`, `viewer_stage`, `outlier_anchor`)
3. `foundation/creator-foundation.md`, iceberg statement, Top 3 problems, avatar, credibility brags
4. `foundation/voice-profile.md`, opener pattern, energy baseline (style only, not for writing prose yet)
