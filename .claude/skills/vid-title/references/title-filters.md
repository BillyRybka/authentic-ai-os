...
- **Audience mismatch.** Avatar is solo founders but the title says "Why Every CEO Should X". Tends to bring the wrong viewers. The creator might be broadening on purpose. Flag and ask.
- **Colons and pipes.** "Tutorial: How To X" or "X | Y | Z". Tend to read as cluttered. Some news-flavored titles use them well. Flag, do not auto-cut.
- **Credibility mismatch.** "My Morning Routine", "79 Minutes Of Advice", "How I Built A $1M Business". Tend to fail on small or new channels because cold viewers do not yet care about an unknown "I". If a single dramatic, specific claim earns the credibility, it can land regardless of channel size. Flag and let the creator decide.
- **Mid-title period or two-sentence smash-up.** The "X. Y." pattern tends to read as fragments. Some titles use period-as-punch on purpose ("STOP. THIS IS IMPORTANT."). Flag with the reasoning.
- **Number-stuffing.** Three or more separate numbers tend to read as a data dump. Some land: "$3 To $30M In 30 Days" works because the numbers form an arc. Default flag.
- **Parenthetical clutter.** Parentheticals work when they add context that flows ("Change Your Life In 6 Months (My 5-Step Process)"). They tend to fail as tag-on labels ("(3 Changes)", "(For Real)", "(Honest Story)"). Flag the tag-on kind.

The principle: hard cuts block what is literally broken. Soft flags surface what tends to under-perform. The creator gets the final call. The defaults exist because they pattern-match what works most often, not because they are laws.
...
**2. Feel new beats be new.** N (New) is the strongest BENS letter for an audience that has tried solutions and failed. The information does not need to be literally new. Repackaged wisdom hits N if the framing, story, or metaphor is fresh. Do not cut a candidate because the topic is not new; ask whether THIS framing makes the viewer feel they have not seen this take.
