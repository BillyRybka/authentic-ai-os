...
- `foundation/voice-profile.md` exists (preferred hook types, opener pattern, energy baseline, words avoided, anti-patterns)
- `Content/pieces/{slug}/piece.md` exists with `title:` locked AND `format:` set
...
5. `foundation/voice-profile.md` (`preferred_hook_types`, opener pattern, energy baseline, words avoided, anti-patterns, recurring phrases)
6. `foundation/reference-pieces/*.md` (live rhythm exemplars: real finished pieces, used as the cadence anchor)
...
- Pass 1 (Layer 1 core): scan the intro for anti-patterns (hard reject), `words_avoided` (soft reject, propose swap), POV consistency, energy match, recurring-phrase signal
- Pass 2 (Layer 2 context): match the rhythm against the YouTube-script context map in `voice-profile.md`. Sentence rhythm, paragraph ratio (intro is short so this matters less), opener pattern, punctuation signature
...
| `knowledge/voice-rhythm.md` | Sentence-length variation, paragraph structure, opener pattern, punctuation signature, energy modulation |
| `knowledge/voice-pressure-test.md` | Pre-save validation against voice-profile (Pass 1 core, Pass 2 context) |
...
| `foundation/voice-profile.md` | preferred_hook_types, opener pattern, energy baseline, words_avoided, anti_patterns, recurring phrases |
| `foundation/reference-pieces/*.md` | Live rhythm exemplars (real finished pieces, used as cadence anchor) |
| `Content/pieces/{slug}/piece.md` | Locked title, format, goal, pillar |
